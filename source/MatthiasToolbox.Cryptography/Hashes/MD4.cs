...
//    History:
//
//                  ?? ???? Norbert Hranitzky java original version
//                  ?? 2000 Oren Novotny c# port
//    Dienstag, 8. Mai 2007 Matthias Gruber port and tests, comments, final
//
//
///////////////////////////////////////////////////////////////////////////////////////
 ...
 * http://www.rsasecurity.com (RSA Data Security, Inc.) requires attribution 
 * for any work that is derived from the MD4 Message-Digest Algorithm; 
 * for details see http://www.roxen.com/rfc/rfc1320.html (RFC 1320)
 * 
 * This code is ported from Norbert Hranitzky's Java version.
 * (mailto://norbert.hranitzky@mchp.siemens.de)
 */
...
namespace MatthiasToolbox.Cryptography.Hashes
{
    ...
    /// </p>
    /// </remarks>
    public class MD4 : IHashProvider<String>
    {
        ...
        /// <summary>
        /// create a new md4 and initialize the engine
        /// </summary>
        public MD4()
        {
            engineReset();
        ...
        private void engineUpdate(byte[] input, int offset, int len)
        {
            ...
            if (offset < 0 || len < 0 || (long)offset + len > input.Length)
                throw new ArgumentOutOfRangeException("offset", "offset or len out of range");
        ...
        /// <summary>
        /// converts a byte array to a hexadezimal string
        /// </summary>
        /// <param name="a">byte array</param>
        /// <param name="len">number of bytes to process</param>
        /// <returns></returns>
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2233:OperationsShouldNotOverflow", MessageId = "len-2")]
        ...
        {
            return this.GetHexHashFromBytes(data);
        }
