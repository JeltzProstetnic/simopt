...
namespace MatthiasToolbox.Cryptography.Hashes
{
    ...
    public class RIPEMED160 : IHashProvider<String>, IDigestProvider
    {
        ...
        {
            return NetHashes.ComputeHash(data, "RIPEMED160", iv);
        }
