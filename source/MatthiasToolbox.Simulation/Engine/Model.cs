...
namespace MatthiasToolbox.Simulation.Engine
{
    ...
    public class Model : IResettable, IRandom, ISeedSource, IModel
    {
        ...
        private Model(SerializationInfo serInfo, StreamingContext streamContext)
        {
            //instanceCounter = serInfo.GetInt32("instanceCounter");

            //this.Name = serInfo.GetString("Name");
            //this.seed = serInfo.GetInt32("Seed");
            //this.antithetic = serInfo.GetBoolean("antithetic");
            //this.nonStochasticMode = serInfo.GetBoolean("nonStochastic");
            //this.seedChange = serInfo.GetBoolean("seedChange");
            
            //this.IsReset = serInfo.GetBoolean("IsReset");

            //// flags
            //this.initialized = serInfo.GetBoolean("initialized");
            //this.requestStop = serInfo.GetBoolean("requestStop");
            //this.requestPause = serInfo.GetBoolean("requestPause");
            //this.requestInterrupt = serInfo.GetBoolean("requestInterrupt");

            //// timing
            //this.startTime = serInfo.GetDouble("startTime");
            //this.currentTime = serInfo.GetDouble("currentTime");
            //this.endingTime = serInfo.GetDouble("endingTime");
            //this.stepSize = serInfo.GetDouble("stepSize");

            //// stats
            //lastRunDuration = (TimeSpan)serInfo.GetValue("lastRunDuration", typeof(TimeSpan));
            //realStartTime = serInfo.GetDateTime("realStartTime");

            //CurrentState = (ExecutionState)(serInfo.GetInt32("CurrentState"));
            //LogStart = serInfo.GetBoolean("LogStart");
            //LogFinish = serInfo.GetBoolean("LogFinish");

            ///*
            // * 1) settings
            // * 2) restore random stuff A
            // * 3) create sim objects
            // * 4) find existing events
            // * 5) restore event scheduler
            // * 6) schedule future event instances
            // * 7) restore random stuff B
            // * 
            // */
            ...
            //simulationObjects = new Dictionary<string, IEntity>();
