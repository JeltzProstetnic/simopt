...
namespace MatthiasToolbox.Mathematics.Enum
{
    public abstract class Unit
    {
        ...
        private double toSiConversionFactor;
        private double fromSiConversionFactor;
        ...
        public double ToSiConversionFactor { get { return toSiConversionFactor; } }
        public double FromSiConversionFactor { get { return fromSiConversionFactor; } }

        #endregion
        #region ctor

        public Unit(string typeName, string name, string abbreviation, double toSiConversionFactor)
        {
            this.TypeName = typeName;
            this.name = name;
            this.abbreviation = abbreviation;
            this.toSiConversionFactor = toSiConversionFactor;
            this.fromSiConversionFactor = 1 / toSiConversionFactor;
        }
        ...
        public string ToShortString(double value)
        {
            return value.ToString() + " " + abbreviation;
        }
        ...
        public string ToShortString(int value)
        {
            return value.ToString() + " " + abbreviation;
        }
        ...
        public string ToShortString(float value)
        {
            return value.ToString() + " " + abbreviation;
        }
        ...
        public string ToShortString(long value)
        {
            return value.ToString() + " " + abbreviation;
        }
        ...
        public string ToShortString(decimal value)
        {
            return value.ToString() + " " + abbreviation;
        }
