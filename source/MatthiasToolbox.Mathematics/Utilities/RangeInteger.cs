...
namespace MatthiasToolbox.Mathematics.Utilities
{
    /// <summary>
    /// Represents an integer range with minimum and maximum values.
    /// Adapted from Andrew Kirillov's AForge.NET framework 
    ...
    public class RangeInteger
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RangeInteger"/> class.
        /// </summary>
        /// 
        ...
        /// <b>false</b> otherwise.</returns>
        /// 
        public bool IsInside( RangeInteger range )
        {
        ...
        /// <b>false</b> otherwise.</returns>
        /// 
        public bool IsOverlapping( RangeInteger range )
        {
            return ( ( IsInside( range.min ) ) || ( IsInside( range.max ) ) );
        }
    }
