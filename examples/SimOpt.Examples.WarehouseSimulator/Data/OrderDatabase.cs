...
using Vr.WarehouseSimulator.Data.OrderTables;
...
{
    public class OrderDatabase : DataContext // : Devart.Data.Linq.DataContext // replacement when switching from OracleClient to dotConnect
    {
        #region cvar
        ...
        public readonly ArticleWrapper ArticleTable = new ArticleWrapper();
        public readonly OrderPositionWrapper OrderPositionTable = new OrderPositionWrapper();
        ...
        public OrderDatabase(OracleConnection connection)
            : base(connection)
        {
