...
namespace SimOpt.Simulation
{
    ...
    /// </summary>
    public class SIM_INFO { static SIM_INFO() { SimOpt.Logging.Logger.RegisterMessageClass(typeof(SIM_INFO), 1); } }

    /// <summary>
    /// simulation info logging message class
    /// </summary>
    public class SIM_WARNING { static SIM_WARNING() { SimOpt.Logging.Logger.RegisterMessageClass(typeof(SIM_WARNING), 2); } }

    /// <summary>
    /// simulation info logging message class
    /// </summary>
    public class SIM_ERROR { static SIM_ERROR() { SimOpt.Logging.Logger.RegisterMessageClass(typeof(SIM_ERROR), 3); } }

    /// <summary>
    /// simulation info logging message class
    /// </summary>
    public class SIM_FATAL { static SIM_FATAL() { SimOpt.Logging.Logger.RegisterMessageClass(typeof(SIM_FATAL), 4); } }

    /// <summary>
    /// simulation event logging message class
    /// </summary>
    public class EVENT { static EVENT() { SimOpt.Logging.Logger.RegisterMessageClass(typeof(EVENT)); } }
    ...
    public static class Simulator
    {
        ...
        {
            SimOpt.Logging.Logger.Add(logger, LoggerSettings);
        }
