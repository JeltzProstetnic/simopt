...
{
    /// <summary>
    /// A wrapper for SimOpt.Mathematics.Stochastics.Random<T> to enable
    ...
    [Serializable]
    public class Random<T> : SimOpt.Mathematics.Stochastics.Random<T>, IResettable, IRandom, ISerializableSimulation
    {
        #region prop
