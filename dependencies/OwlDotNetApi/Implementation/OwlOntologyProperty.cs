...
namespace OwlDotNetApi
{
	...
	/// </summary>
	public class OwlOntologyProperty : OwlProperty, IOwlOntologyProperty
	{
		#region Creators
		/// <summary>
		...
		public OwlOntologyProperty()
		{
			_typeEdge = new OwlEdge(OwlNamespaceCollection.RdfNamespace+"type");
			_typeEdge.AttachChildNode(new OwlNode(OwlNamespaceCollection.OwlNamespace+"OntologyProperty"));
		...
		public OwlOntologyProperty(string nodeUri, OwlNode typeNode)
		{
			if(typeNode == null)
		...
		/// <param name="nodeUri">A string representing the URI of this Property</param>
		/// <remarks>This constructor creates a new OwlNode with URI owl:OntologyProperty and sets it as the child node of an edge with URI rdf:type</remarks>	
		public OwlOntologyProperty(string nodeUri)
		{
			ID = nodeUri;
			_typeEdge = new OwlEdge(OwlNamespaceCollection.RdfNamespace+"type");
			_typeEdge.AttachChildNode(new OwlNode(OwlNamespaceCollection.OwlNamespace+"OntologyProperty"));
