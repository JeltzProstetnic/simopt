...
namespace OwlDotNetApi
{
	...
	/// </summary>
	public class OwlIndividual : OwlResource, IOwlIndividual
	{
		#region Creators
		/// <summary>
		...
		public OwlIndividual()
		{
			_typeEdge = new OwlEdge(OwlNamespaceCollection.RdfNamespace+"type");
			_typeEdge.AttachChildNode(new OwlNode(OwlNamespaceCollection.OwlNamespace+"Thing"));
		...
		public OwlIndividual(string nodeUri, OwlNode typeNode)
		{
			if(typeNode == null)
		...
		/// <param name="nodeUri">A string representing the URI of this Resource</param>
		/// <remarks>This constructor creates a new OwlNode with URI owl:Thing and sets it as the child node of an edge with URI rdf:type</remarks>	
		public OwlIndividual(string nodeUri)
		{
			ID = nodeUri;
			_typeEdge = new OwlEdge(OwlNamespaceCollection.RdfNamespace+"type");
			_typeEdge.AttachChildNode(new OwlNode(OwlNamespaceCollection.OwlNamespace+"Thing"));
