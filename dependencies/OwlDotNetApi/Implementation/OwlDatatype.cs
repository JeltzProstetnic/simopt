...
namespace OwlDotNetApi
{
	...
	/// </summary>
	public class OwlDatatype : OwlResource, IOwlDatatype
	{
		#region Creators
		/// <summary>
		...
		public OwlDatatype()
		{
			...
			_typeEdge.AttachChildNode(new OwlNode(OwlNamespaceCollection.RdfSchemaNamespace+"Datatype"));
		...
		public OwlDatatype(string nodeUri, OwlNode typeNode)
		{
			if(typeNode == null)
		...
		/// <param name="nodeUri">A string representing the URI of this Resource</param>
		/// <remarks>This constructor creates a new OwlNode with URI rdfs:Datatype and sets it as the child node of an edge with URI rdf:type</remarks>	
		public OwlDatatype(string nodeUri)
		{
			ID = nodeUri;
			_typeEdge = new OwlEdge(OwlNamespaceCollection.RdfNamespace+"type");
			_typeEdge.AttachChildNode(new OwlNode(OwlNamespaceCollection.RdfSchemaNamespace+"Datatype"));
