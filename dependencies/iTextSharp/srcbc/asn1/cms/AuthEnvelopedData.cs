...
namespace Org.BouncyCastle.Asn1.Cms
{
		...
		: Asn1Encodable
	{
			...
			Asn1Set					unauthAttrs)
		{
			...
			// TODO: There MUST be at least one element in the collection.
			this.recipientInfos = recipientInfos;

			this.authEncryptedContentInfo = authEncryptedContentInfo;

			// TODO: The authAttrs MUST be present if the content type carried in EncryptedContentInfo is not id-data."
