...
using MatthiasToolbox.Presentation.XamlToHtmlParser;

namespace MatthiasToolbox.Presentation.AttachedProperties
{
    public static class RichTextEditorProperties
    {
        public static readonly DependencyProperty BoundDocument =
           DependencyProperty.RegisterAttached("BoundDocument", typeof(string), typeof(RichTextEditorProperties),
